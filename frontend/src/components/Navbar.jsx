...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 h-20 bg-black/40 backdrop-blur-3xl border-b border-white/[0.04] z-[100] px-6 sm:px-12 flex items-center justify-between selection:bg-white/10">
      <div className="absolute inset-0 neural-grain opacity-[0.03] pointer-events-none" />
      
      <Link to="/" className="flex items-center gap-4 group cursor-pointer">
        <div className="w-10 h-10 glass flex items-center justify-center border-white/5 group-hover:bg-white group-hover:text-black transition-all duration-700 shadow-2xl">
        ...
        <div className="glass-text-inner !px-4 !py-1">
          <h1 className="text-[10px] font-black uppercase tracking-[0.5em] text-white">Pixel Forge AI</h1>
        </div>
      </Link>
      ...
      <div className="flex items-center gap-8 sm:gap-12">
        <Link 
          ...
          className="text-[9px] font-black uppercase tracking-[0.4em] text-gray-700 hover:text-white transition-all hidden sm:block cursor-pointer"
        >
          About
        </Link>
        ...
        {user ? (
          <div className="relative">
            <button 
                ...
                className="flex items-center gap-4 glass !pr-4 !pl-2 py-1.5 border-white/10 hover:bg-white/5 transition-all group"
            >
                <div className="relative">
            ...
            <AnimatePresence>
                {showIdentity && (
                   <motion.div 
                     ...
                     className="absolute right-0 mt-4 w-64 glass-strong p-4 border-white/10 shadow-4xl"
                   >
          ...
          <Link to="/login">
            <button className="flex items-center gap-4 glass !px-6 py-2.5 border-white/10 hover:bg-white/5 transition-all group relative overflow-hidden">
                <div className="absolute inset-0 bg-white opacity-0 group-hover:opacity-5 transition-opacity" />
                <div className="relative flex items-center gap-3">
                   <div className="relative">
                      <FcGoogle className="w-4 h-4 relative z-10" />
